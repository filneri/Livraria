...
namespace TesteLivraria.DB
{
    public class LivroDB : Conector
    {
        ...
        {
            String sql = "Insert into Livro(ISBN,Nome,Preco,DataPublicacao,idautor) Values(?0,?1,?2,?3,?4)";
        ...
        {
            String sql = "select l.idlivro,l.isbn,l.nome as livro,l.preco,l.datapublicacao,l.idautor,a.nome as autor from livro l inner join autor a on l.idautor = a.idautor";
